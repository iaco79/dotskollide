...
*/
#ifndef GGAMESTATE_CLASS
#define GGAMESTATE_CLASS

#include "GameDefines.h"
#include "GGameManager.h"


class GGameState : public GEventHandler
{
protected:
	bool mHasFocus;
...
public:
	...
	virtual void VOnGetFocus(int param) { mHasFocus=true; };
	virtual void VOnLostFocus() { mHasFocus=false;  };
	...
	virtual int  VGameStateId() { return 0;};
