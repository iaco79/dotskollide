...
*/
#ifndef TGAMESTATEOPTIONS_CLASS
#define TGAMESTATEOPTIONS_CLASS
...
class TGameStateOptions: public GGameState ,
					GRocketEventHandler
{
...
public:
	...
	TGameStateOptions(void);
	virtual ~TGameStateOptions(void);
