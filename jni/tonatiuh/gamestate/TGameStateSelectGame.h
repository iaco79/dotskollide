...
*/
#ifndef TGAMESTATESELECTGAME_CLASS
#define TGAMESTATESELECTGAME_CLASS
...
class TGameStateSelectGame: public GGameState ,
					GRocketEventHandler
{
...
public:
	...
	TGameStateSelectGame(void);
	virtual ~TGameStateSelectGame(void);
