...
TObjectFactory::TObjectFactory(irr::io::IFileSystem* fs) : 
	GObjectFactory(fs) //<-- register default game components
{
	//+ register tonatiuh components
	mComponentFactory.Register<TSpringGridComponent>(T_GC_SPRINGRID_IDX,GComponent::GetIdFromName(TSpringGridComponent::mName));
