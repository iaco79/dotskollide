...
#define OOLUA_PARAMS_T_INTERNAL_1\
	OOLUA_INTERNAL_PARAM_T(1)

#define OOLUA_PARAMS_T_INTERNAL_2\
	OOLUA_INTERNAL_PARAM_T(2)\
	OOLUA_PARAMS_T_INTERNAL_1

#define OOLUA_PARAMS_T_INTERNAL_3\
	OOLUA_INTERNAL_PARAM_T(3)\
	OOLUA_PARAMS_T_INTERNAL_2

#define OOLUA_PARAMS_T_INTERNAL_4\
	OOLUA_INTERNAL_PARAM_T(4)\
	OOLUA_PARAMS_T_INTERNAL_3

#define OOLUA_PARAMS_T_INTERNAL_5\
	OOLUA_INTERNAL_PARAM_T(5)\
	OOLUA_PARAMS_T_INTERNAL_4

#define OOLUA_PARAMS_T_INTERNAL_6\
	OOLUA_INTERNAL_PARAM_T(6)\
	OOLUA_PARAMS_T_INTERNAL_5

#define OOLUA_PARAMS_T_INTERNAL_7\
	OOLUA_INTERNAL_PARAM_T(7)\
	OOLUA_PARAMS_T_INTERNAL_6

#define OOLUA_PARAMS_T_INTERNAL_8\
	OOLUA_INTERNAL_PARAM_T(8)\
	OOLUA_PARAMS_T_INTERNAL_7
