...
SDL_RunAudio(void *devicep)
{
	...
	#if defined(ANDROID)
		__android_log_print(ANDROID_LOG_INFO, "SDL_Audio.c", "starting SDL_RunAudio");

		if(device)
				__android_log_print(ANDROID_LOG_INFO, "SDL_Audio.c", "device ok");
		else
				__android_log_print(ANDROID_LOG_INFO, "SDL_Audio.c", "device NULL");
	...
	#if defined(ANDROID)
		__android_log_print(ANDROID_LOG_INFO, "SDL_Audio.c", "SDL_SetThreadPriority");
	#endif
	...
	#if defined(ANDROID)
		__android_log_print(ANDROID_LOG_INFO, "SDL_Audio.c", "impl ThreadInit");
	#endif
                  ...
                  int allowed_changes, int min_id)
{
...
#if defined(ANDROID)
	__android_log_print(ANDROID_LOG_INFO, "SDL_Audio.c", "Open Device ok");
#endif
...
#if defined(ANDROID)
	__android_log_print(ANDROID_LOG_INFO, "SDL_Audio.c", "fake stream ok");
#endif
    ...
    if (build_cvt) {
        ...
        if (SDL_BuildAudioCVT(&device->convert,
			...
			#if defined(ANDROID)
			__android_log_print(ANDROID_LOG_INFO, "SDL_Audio.c", "SDL_BuildAudioCVT fail");
			#endif
        ...
        if (device->convert.needed) {
            ...
            if (device->convert.buf == NULL) {
				...
				#if defined(ANDROID)
				__android_log_print(ANDROID_LOG_INFO, "SDL_Audio.c", "SDL_AllocAudioMem fail");
				#endif
    ...
    if (id == SDL_arraysize(open_devices)) {
		...
		#if defined(ANDROID)
		__android_log_print(ANDROID_LOG_INFO, "SDL_Audio.c", "Too many open audio devices fail");
		#endif
...
#undef SDL_CreateThread
...
#else
		#if defined(ANDROID)
		__android_log_print(ANDROID_LOG_INFO, "SDL_Audio.c", "trying to create audio thread");
		#endif
		...
		#if defined(ANDROID)
		__android_log_print(ANDROID_LOG_INFO, "SDL_Audio.c", "reate audio thread ok");
		#endif
        ...
        if (device->thread == NULL) {
			...
			#if defined(ANDROID)
			__android_log_print(ANDROID_LOG_INFO, "SDL_Audio.c", "Couldn't create audio thread");
			#endif
