...
#ifdef USE_IRRLICHT_FS
#include "../../../Game/sdl/SDLFS.h"
#endif
...
SDL_RWFromFile(const char *file, const char *mode)
{
	...
	if (irr_sdl_fs_open(rwops, file, mode) < 0)
	{
        SDL_FreeRW(rwops);
        return NULL;
    }
    ...
    rwops->size = irr_sdl_fs_size;
    rwops->seek = irr_sdl_fs_seek;
    rwops->read = irr_sdl_fs_read;
    rwops->write = irr_sdl_fs_write;
    rwops->close = irr_sdl_fs_close;
