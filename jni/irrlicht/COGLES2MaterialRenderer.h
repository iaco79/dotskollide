...
//          resetAllRenderstates)
                {
                    ...
                    //IACO FixedPipeline->enableAlphaTest();
                    //IACO FixedPipeline->setAlphaValue( 0.f );
                    Driver->enableBlend();
...
//! Transparent alpha channel material renderer
        ...
        public:
                                        ...
                                        bool resetAllRenderstates, IMaterialRendererServices* services )
            {
                ...
                if (material.MaterialType != lastMaterial.MaterialType || resetAllRenderstates
                     ||  material.MaterialTypeParam != lastMaterial.MaterialTypeParam 
					 ||  material.getTexture(0) != lastMaterial.getTexture(0)
					 )
                { 
                    
					Driver->blendFunc( EBF_SRC_ALPHA, EBF_ONE_MINUS_SRC_ALPHA);
					//Driver->blendFunc( EBF_SRC_ALPHA, EBF_ONE);
                    Driver->enableBlend();
                    FixedPipeline->useProgram();
                    FixedPipeline->setMaterial( material );
                   //IACO FixedPipeline->enableAlphaTest();
