...
//! RTT ColorFrameBuffer constructor
                ...
                : COGLES2Texture( name, driver ), DepthTexture( 0 ), ColorFrameBuffer( 0 )
        {
            ...
            //gDriver->extGlBindFramebuffer( GL_FRAMEBUFFER_OES, ColorFrameBuffer );
            ...
            glTexImage2D( GL_TEXTURE_2D, 0, GL_RGBA, 
						  ImageSize.Width,
                          ImageSize.Height, 0, GL_RGBA, GL_UNSIGNED_BYTE, 0 );
...
#endif
#if  0 //IACO defined(GL_OES_framebuffer_object) && (defined(GL_OES_stencil1) || defined(GL_OES_stencil4) || defined(GL_OES_stencil8))
...
#if 0 //GL_OES_framebuffer_object
