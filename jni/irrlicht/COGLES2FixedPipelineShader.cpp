...
namespace irr
{
    namespace video
    {
	...
	#if defined WIN32
		const c8 VertexShaderFile[] = "IrrlichtSdcard/COGLES2FixedPipeline.vsh";
        const c8 FragmentShaderFile[] = "IrrlichtSdcard/COGLES2FixedPipeline.fsh";
		//const c8 VertexShaderFile[] = "IrrlichtSdcard/MyShader.vsh";
        //const c8 FragmentShaderFile[] = "IrrlichtSdcard/MyShader.fsh";
        ...
        {
            for ( size_t i = 0; i < 1 /*MAX_TEXTURE_UNITS*/; ++i )
                TextureUnits[i] = i;
        ...
        bool COGLES2FixedPipelineShader::OnRender( IMaterialRendererServices* service, E_VERTEX_TYPE vtxtype )
        {
            ...
            if ( Lighting )
            {
                ...
                // IACO setUniform( LIGHT_DIRECTION, LightDirection, MAX_LIGHTS );
                ...
                // IACO setUniform( LIGHT_SPECULAR, LightSpecular, MAX_LIGHTS );
                ...
                // IACO setUniform( LIGHT_EXPONENT, LightExponent, MAX_LIGHTS );
                //statusOk &= setVertexShaderConstant( "uLightCutoff",   LightCutoff,   MAX_LIGHTS );
                // IACO setUniform( LIGHT_CUTOFF, LightCutoff, MAX_LIGHTS );
