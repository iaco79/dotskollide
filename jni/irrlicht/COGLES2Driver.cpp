...
// -----------------------------------------------------------------------
        ...
        { 
			...
			os::Printer::log( "Creating fixed pipeline material renderers." );
            createMaterialRenderers();

            // set the renderstates
			os::Printer::log( "Setting render state 3D Mode." );

			
            setRenderStates3DMode();

            // set fog mode
			os::Printer::log( "Setting fog Mode." );
            setFog( FogColor, FogType, FogStart, FogEnd, FogDensity, PixelFog, RangeFog );

            // create matrix for flipping textures
			os::Printer::log( "create matrix for flipping textures." );
			...
			os::Printer::log( "Using program 0." );
            glUseProgram( 0 );
            testGLError();
...
//! Sets a constant for the pixel shader based on a name.
        bool COGLES2Driver::setPixelShaderConstant( const c8* name, int value)
        {
            os::Printer::log( "Error: Please call services->setPixelShaderConstant(), not VideoDriver->setPixelShaderConstant()." );
            return false;
        }
